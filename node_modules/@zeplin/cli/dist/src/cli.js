...
function beforeCommand() {
    const un = (0, update_notifier_1.default)({
        pkg: {
...
const connectCommand = program.command("connect")
    ...
    .action((0, commander_2.commandRunner)((options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield (0, connect_1.connect)(connectOptions);
})));
connectCommand.command("delete")
    ...
    yield (0, connect_1.connectDelete)(connectDeleteOptions);
})));
connectCommand.command("initialize")
    ...
    yield (0, initialize_1.initialize)(opts);
})));
connectCommand.command("add-components")
    ...
    yield (0, addComponent_1.addComponent)(opts);
})));
const loginCommand = program.command("login")
    ...
    yield (0, login_1.login)(loginOptions);
})));
...
[
    ...
    command.on("option:verbose", () => (0, env_1.activateVerbose)());
    command.on("option:ci", () => (0, env_1.activateCI)());
});
program.on("command:*", () => {
    program.outputHelp();
});
