...
const validateConfigSchema = (config, params) => {
    ...
    const relativeFilePath = (0, file_1.getAsRelativePath)(params.filePath);
    if (error) {
...
const configExplorerOptions = {
    ...
    loaders: {
        ".json": (_filePath, content) => {
            const stripped = (0, strip_comments_1.default)(content);
...
const configExplorer = (0, cosmiconfig_1.cosmiconfig)("@zeplin/cli", configExplorerOptions);
const getComponentConfigFile = (filePath) => __awaiter(void 0, void 0, void 0, function* () {
    let result;
    const relativeFilePath = (0, file_1.getAsRelativePath)(filePath);
    try {
