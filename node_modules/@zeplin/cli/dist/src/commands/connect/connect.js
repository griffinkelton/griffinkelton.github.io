...
const generateConnectedComponents = (options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const componentConfigFiles = yield (0, config_1.getComponentConfigFiles)(configFiles, plugins);
    logger_1.default.debug(`component config files: ${(0, text_1.stringify)(componentConfigFiles)}`);
    const connectedBarrels = yield (0, plugin_1.connectComponentConfigFiles)(componentConfigFiles);
    logger_1.default.debug(`connected barrels output: ${(0, text_1.stringify)(connectedBarrels)}`);
...
const startDevServer = (options, connectedBarrels) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    logger_1.default.info("Starting development server…");
    ...
    if (devModeWatch) {
        ...
        watcher.on("change", (filePath) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            try {
                ...
                logger_1.default.error(chalk_1.default.red((0, ts_dedent_1.default) `
...
const upload = (connectedBarrels) => __awaiter(void 0, void 0, void 0, function* () {
    logger_1.default.info("Connecting all Connected Components into Zeplin…");
    yield service.uploadConnectedBarrels(connectedBarrels);
    logger_1.default.info("🦄 Components successfully connected to components in Zeplin.");
});
function connect(options) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            logger_1.default.debug(`connect options: ${(0, text_1.stringify)(options)}`);
            ...
            error.message = (0, ts_dedent_1.default) `
            ${chalk_1.default.bold `Connecting components to Zeplin components failed.`}

            ${chalk_1.default.redBright((0, text_1.indent)(error.message))}
        `;
            throw error;
        }
    });
