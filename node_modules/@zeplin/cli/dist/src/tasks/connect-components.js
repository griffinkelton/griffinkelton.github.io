...
const connect = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    if (ctx.installGlobally && ctx.installedPlugins.length > 0) {
        ...
        yield (0, command_1.runCommand)(`zeplin connect --file ${ctx.cliOptions.configFile}`, {
            shell: true,
            env: Object.assign(process.env, { PATH: (0, npx_1.removeNpxFromPath)(process.env.PATH) })
        });
    }
    else {
        logger_1.default.debug("Running connect internally");
        const connectedComponents = yield (0, commands_1.generateConnectedComponents)({
...
exports.connectComponents = new task_1.Task({
    steps: [
        ...
        checkAuthentication,
        connect,
        (0, task_1.transitionTo)(ui.completed)
    ],
    initial: ui.initial
});
