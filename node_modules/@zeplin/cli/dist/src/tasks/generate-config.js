...
const writeFile = (filePath, config) => __awaiter(void 0, void 0, void 0, function* () {
    yield (0, file_1.mkdir)(path_1.default.dirname(filePath));
    yield (0, file_1.writeJsonIntoFile)(filePath, config);
});
...
const generate = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    logger_1.default.debug(`Generated config file: ${(0, text_1.stringify)(config)}`);
